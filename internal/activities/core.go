...
type IPActivityManager struct {
	HTTPClient HTTPGetter
}

// GetIP fetches the public IP address.
func (i *IPActivityManager) GetIP(ctx context.Context) (string, error) {
...
func (i *IPActivityManager) GetLocationInfo(ctx context.Context, ip string) (string, error) {
